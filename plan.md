...
- Los dos CV en `/cv/` sustituidos (17 sep 2026, `Downloads/CV/`) por la
  versión con AB10 corregido y verificados con `pdftotext` antes de copiarlos:
  ambos dicen ya «AB10 – Ayudas a familias».

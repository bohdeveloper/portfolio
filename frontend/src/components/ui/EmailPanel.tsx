    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 hidden md:flex flex-col items-center">
        ...
        <a
          ...
          className="text-gray-700 dark:text-white hover:text-cyan-400 dark:hover:text-cyan-400 transition p-2 border-b border-gray-400 dark:border-white hover:border-cyan-400 dark:hover:border-cyan-400"
        >
          ohb_1@outlook.com
        </a>
      </div>
